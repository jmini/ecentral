...
The tool used to perform this task is called link:https://wiki.eclipse.org/CBI/aggregator[CBI Aggregator] and the setup to publish to maven central is defined in the link:https://git.eclipse.org/c/platform/eclipse.platform.releng.git/[eclipse.platform.releng] project.
...
The code used to generate the data can be found the git-link:src/[src/] folder.
